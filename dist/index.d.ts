import { JSONContent, Extension } from '@tiptap/react';
import { EditorProps } from '@tiptap/pm/view';
import { Editor as Editor$1 } from '@tiptap/core';

declare function Editor({ completionApi, className, defaultValue, extensions, editorProps, onUpdate, onDebouncedUpdate, debounceDuration, storageKey, }: {
    /**
